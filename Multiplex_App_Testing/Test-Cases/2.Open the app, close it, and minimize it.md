...
## Screenshots:
<div><div style="display: inline-block; text-align: center; margin-right: 20px;">
  <p><strong>1. App icon</strong></p>
  <img src="../../Multiplex_App_Testing/images/2. App open, close, minimize/1. App Icon.jpg"
       alt="App Icon"
       width="300">
</div>

<div style="display: inline-block; text-align: center;">
  <p><strong>2. Swiping to the bottom</strong></p>
  <img src="../../Multiplex_App_Testing/images/2. App open, close, minimize/2.Swiping to the bottom.jpg"
       alt="Swiping to the bottom"
       width="300">
</div>
</div>
